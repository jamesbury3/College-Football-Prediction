...
predictions = suppressWarnings(predict.glm(model, test, type = "response"))
predictions = ifelse(predictions >= 0.5, 1, 0)
paste("Logistic Regression Accuracy on 30% test",sum(ifelse(predictions == test$Outcome, 1, 0)) / nrow(test))
```
